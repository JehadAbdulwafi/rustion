...
func TestPostPlayStream(t *testing.T) {
	test.WithTestServer(t, func(s *api.Server) {
		...
		res := test.PerformRequest(t, s, "POST", "/api/v1/streams/play", reqBody, nil)
...
func TestPostPlayStreamOffline(t *testing.T) {
	test.WithTestServer(t, func(s *api.Server) {
		fixtures := test.Fixtures()
...
func TestPostPlayStreamStopAction(t *testing.T) {
	test.WithTestServer(t, func(s *api.Server) {
		fixtures := test.Fixtures()
