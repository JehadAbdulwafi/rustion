...
func GetFeedbackRoute(s *api.Server) *echo.Route {
	return s.Router.APIV1Feedback.GET("/:id", getFeedbackHandler(s))
}

func getFeedbackHandler(s *api.Server) echo.HandlerFunc {
