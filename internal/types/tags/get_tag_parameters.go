...
func (o *GetTagParams) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *GetTagParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTagParams) validateID(formats strfmt.Registry) error {
