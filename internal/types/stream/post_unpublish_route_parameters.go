...
// NewPostUnpublishRouteParams creates a new PostUnpublishRouteParams object
// no default values defined in spec.
func NewPostUnpublishRouteParams() PostUnpublishRouteParams {

	return PostUnpublishRouteParams{}
}

// PostUnpublishRouteParams contains all the bound params for the post unpublish route operation
...
func (o *PostUnpublishRouteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
