...
// NewPostPublishRouteParams creates a new PostPublishRouteParams object
// no default values defined in spec.
func NewPostPublishRouteParams() PostPublishRouteParams {

	return PostPublishRouteParams{}
}

// PostPublishRouteParams contains all the bound params for the post publish route operation
