...
export function PriceCards({ loading = defaultProps.loading, frequency = defaultProps.frequency, priceMap = {} }: Props) {
  return (
    <div className="isolate mx-auto grid grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      {PricingTier.map((tier) => (
        <div key={tier.id} className={cn('rounded-2xl bg-background/70 backdrop-blur-[6px] overflow-hidden')}>
