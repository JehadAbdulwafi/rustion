...
import (
	...
	"github.com/JehadAbdulwafi/rustion/scripts/internal/scaffold"
...
var (
	modelPath   = filepath.Join(projectRoot, "internal/database/models.go")
...
func generate(cmd *cobra.Command, args []string) {
	...
	resource, err := scaffold.ParseModel(modelPath, resourceName)
	if err != nil {
